...
Button1 = tk.Button(root, text="select unorganised folder",activeforeground="pink", height=5, width=50, command=lambda : [folder1(),changeText1()])
Button1.pack()

Button2 = tk.Button(root, text="select organised folder",activeforeground="pink", height=5, width=50, command=lambda : [folder2(),changeText2()])
Button2.pack()

Button3 = tk.Button(root, text="Run Me//0W sorter",activeforeground="pink", height=5, width=50, command=Run )
Button3.pack()
