...
path = "/Volumes/WinInstall/sorted"
folder_selected1 = "/Volumes/WinInstall/to sort"
...
def Run():
    ...
    for subdir, dirs, files in os.walk(path):
        ...
        for file in files:
            ...
            months_nom = ['00-IgotLazy','01 - January','02 - February','03 - March','04 - April','05 - may','06 - June','07 - July','08 - August','09 - September','10 - October','11 - November','12 - December']
            ...
            os.chdir(folder_selected2+'/'+modificationTime2+'/'+months_nom[int(modificationTime1)]+'/'+dayFolder)
...
Button1 = tk.Button(root, text="select unorganised folder",activeforeground="blue", height=5, width=50, command=lambda : [folder1(),changeText1()])
Button1.pack()

Button2 = tk.Button(root, text="select organised folder",activeforeground="blue", height=5, width=50, command=lambda : [folder2(),changeText2()])
Button2.pack()

Button3 = tk.Button(root, text="Run Me//0W sorter",activeforeground="green", height=5, width=50, command=Run )
Button3.pack()

Button4 = tk.Button(root, bg='black', text="UNDO (!!Will dump all files in one folder!!)",activeforeground="red", height=5, width=50, command=Undo)
Button4.pack()
