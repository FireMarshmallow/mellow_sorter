...
items_in_import_folder = next(os.walk(import_dir))[2] #this looks at the number of item in the import folder and sets the loop cicels
...
noOfDir = 0
for base, dirs, files in os.walk(temp_dir): #this looks at the numbe of folders in the temp folder and sets the loop cicels
