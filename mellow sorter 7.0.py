...
def Run():
    ...
    for subdir, dirs, files in os.walk(path):
        ...
        for file in files:
            ...
            months_nom = ['thisisnothint', '01 - January', '02 - February', '03 - March', '04 - April', '05 - may',
...
Button1 = tk.Button(root, text="select unorganised folder",
                    activeforeground="pink", height=5, width=50, command=folder1)
Button1.pack()
Button2 = tk.Button(root, text="select organised folder",
                    activeforeground="pink", height=5, width=50, command=folder2)
Button2.pack()
Button3 = tk.Button(root, text="Run mello sorter",
