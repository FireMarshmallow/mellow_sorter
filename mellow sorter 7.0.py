    ...
    for subdir, dirs, files in os.walk(path):
        ...
        for file in files:
            ...
            if not os.path.exists(file):
                ...
                print(file,'exists')
        print('All done bye')
Button1 = tk.Button(root, text="select unorganised folder",activeforeground="pink", height=5, width=50, command=folder1 )
Button1.pack()
Button2 = tk.Button(root, text="select organised folder",activeforeground="pink", height=5, width=50, command=folder2 )
Button2.pack()
Button3 = tk.Button(root, text="Run mello sorter",activeforeground="pink", height=5, width=50, command=Run )
Button3.pack()
root.mainloop()